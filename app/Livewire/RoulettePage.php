...
// Метод для получения данных о ставках (позициях и количестве стэков)
    ...
    public function getTrainingPositions()
    {
        ...
        return [
            ...
            ['id' => 4, 'x' => 33, 'y' => 40, 'stacks' => 4],  // правый верхний угол
            ['id' => 5, 'x' => 50, 'y' => 40, 'stacks' => 5],  // левый средний
            ['id' => 6, 'x' => 66, 'y' => 40, 'stacks' => 6],  // центр среднего
            ['id' => 7, 'x' => 33, 'y' => 60, 'stacks' => 7],  // правый средний
            ['id' => 8, 'x' => 50, 'y' => 60, 'stacks' => 8],  // левый нижний
            ['id' => 9, 'x' => 66, 'y' => 60, 'stacks' => 9],  // центр нижнего
            ['id' => 10, 'x' => 33, 'y' => 83, 'stacks' => 10], // правый нижний
            ['id' => 11, 'x' => 50, 'y' => 83, 'stacks' => 10], // правый нижний
            ['id' => 12, 'x' => 66, 'y' => 83, 'stacks' => 10], // правый нижний
        ];
    }
